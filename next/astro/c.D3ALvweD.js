import { c as createAstro, a as createComponent, m as maybeRenderHead, d as addAttribute, h as renderScript, b as renderTemplate, u as unescapeHTML, i as renderHead, r as renderComponent, j as renderSlot } from './c.CCTiTH7s.js';
import 'piccolore';
/* empty css           */
import 'clsx';
...
const $$Base = createComponent(($$result, $$props, $$slots) => {
  ...
  const nav = [
    ["about", "About", home ? "#about" : href("#about")],
  ...
  const favicon = "data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 32 32'%3E%3Crect width='32' height='32' rx='7' fill='%23120a1c'/%3E%3Ccircle cx='16' cy='16' r='7' fill='%23c8b5ff'/%3E%3C/svg%3E";
  return renderTemplate`<html lang="en" data-astro-cid-5hce7sga> <head><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1"><title>${title}</title><meta name="description"${addAttribute(description, "content")}><meta name="theme-color" content="#120a1c"><link rel="icon"${addAttribute(favicon, "href")}><link rel="sitemap"${addAttribute(href("sitemap-index.xml"), "href")}><meta property="og:type" content="profile"><meta property="og:title"${addAttribute(title, "content")}><meta property="og:description"${addAttribute(description, "content")}><meta property="og:image"${addAttribute(new URL(href("portrait.jpg"), Astro2.site), "content")}><meta name="twitter:card" content="summary"><link rel="preconnect" href="https://fonts.googleapis.com"><link rel="preconnect" href="https://fonts.gstatic.com" crossorigin><link rel="stylesheet" href="https://fonts.googleapis.com/css2?family=Newsreader:ital,opsz,wght@0,6..72,400;0,6..72,500;0,6..72,600;1,6..72,400&family=JetBrains+Mono:wght@400;500&display=swap">${renderHead()}</head> <body data-astro-cid-5hce7sga> <header class="top" data-astro-cid-5hce7sga> <nav class="wrap topnav label" aria-label="Site" data-astro-cid-5hce7sga> ${nav.map(([id, text, url]) => renderTemplate`<a${addAttribute(url, "href")}${addAttribute(current === id ? "page" : void 0, "aria-current")} data-astro-cid-5hce7sga>${text}</a>`)} </nav> </header> <div class="wrap layout" data-astro-cid-5hce7sga> <aside class="side" data-astro-cid-5hce7sga> <a class="photo"${addAttribute(href(""), "href")} aria-label="Home" data-astro-cid-5hce7sga> ${renderComponent($$result, "Portrait", $$Portrait, { "src": portrait, "alt": `Portrait of ${profile.name}`, "data-astro-cid-5hce7sga": true })} </a> <h1 class="name" data-astro-cid-5hce7sga>${profile.name}</h1> <p class="role" data-astro-cid-5hce7sga>${profile.role} · <a${addAttribute(profile.orgHref, "href")} target="_blank" rel="noopener" data-astro-cid-5hce7sga>${profile.org}</a></p> <p class="where label" data-astro-cid-5hce7sga>${profile.location}, Bulgaria</p> <ul class="contacts" data-astro-cid-5hce7sga> <li data-astro-cid-5hce7sga><a${addAttribute(`mailto:${profile.email}`, "href")} data-astro-cid-5hce7sga>${renderComponent($$result, "Icon", $$Icon, { "name": "mail", "size": 15, "data-astro-cid-5hce7sga": true })} ${profile.email}</a></li> <li data-astro-cid-5hce7sga><a${addAttribute(profile.links.scholar, "href")} target="_blank" rel="noopener" data-astro-cid-5hce7sga>${renderComponent($$result, "Icon", $$Icon, { "name": "scholar", "size": 15, "data-astro-cid-5hce7sga": true })} Google Scholar</a></li> <li data-astro-cid-5hce7sga><a${addAttribute(profile.links.github, "href")} target="_blank" rel="noopener" data-astro-cid-5hce7sga>${renderComponent($$result, "Icon", $$Icon, { "name": "github", "size": 15, "data-astro-cid-5hce7sga": true })} GitHub</a></li> <li data-astro-cid-5hce7sga><a${addAttribute(profile.links.linkedin, "href")} target="_blank" rel="noopener" data-astro-cid-5hce7sga>${renderComponent($$result, "Icon", $$Icon, { "name": "linkedin", "size": 14, "data-astro-cid-5hce7sga": true })} LinkedIn</a></li> <li data-astro-cid-5hce7sga><a${addAttribute(profile.links.telegram, "href")} target="_blank" rel="noopener" data-astro-cid-5hce7sga>${renderComponent($$result, "Icon", $$Icon, { "name": "telegram", "size": 15, "data-astro-cid-5hce7sga": true })} Telegram</a></li> <li data-astro-cid-5hce7sga><a${addAttribute(href("cv"), "href")} data-astro-cid-5hce7sga>${renderComponent($$result, "Icon", $$Icon, { "name": "file", "size": 15, "data-astro-cid-5hce7sga": true })} Curriculum vitae</a></li> </ul> </aside> <main class="main" data-astro-cid-5hce7sga> ${renderSlot($$result, $$slots["default"])} <footer class="foot label" data-astro-cid-5hce7sga>© ${(/* @__PURE__ */ new Date()).getFullYear()} ${profile.name}</footer> </main> </div> </body></html>`;
